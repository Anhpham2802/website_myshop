                ...
                <div className="mx-1 border-[1px] rounded-md border-[#edeceb] w-2/3">
                    ...
                    <div className="h-fit mx-7 mt-5 py-3 flex justify-between border-b-[1px] border-b-[#edeceb]">
                        ...
                        <div className="w-1/2 mx-4">
                            <p className='font-thin mt-1 text-[17px] font-serif h-[50px] overflow-hidden'>Tên sản phẩm fdd gsc zaw fbeghbwns czbzeufhjwbsxfguwsfv efguvfuhfv du vgydus hivdbjyubf ygujgjyuk  bukibgvuyg gyuh  yugh</p>
